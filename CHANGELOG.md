...
- **Search in Settings and About** — a search box sits beside the tabs: type a word ("hotkey", "HDR", "log") and the tab you're on keeps only the cards that mention it, with the word highlighted and the first match scrolled into view. All searches every section, and the search stays as you switch tabs. Ctrl+F jumps to the box; its x or Esc clears it.
