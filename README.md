...
- **Just shortcuts**: drop a program, its shortcut, or a Microsoft Store app dragged from shell:AppsFolder on the Tools page. Nothing is scanned or looked up, and no game features apply (no profile, scripts or playtime).
