...
Clear in the flyout, or Clear filters in that message, removes every tick at once. Clear leaves the flyout open, so you can pick a different filter straight away.
